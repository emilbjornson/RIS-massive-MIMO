...
for scenario = 1:2
    ...
    if scenario == 1
        ...
        ConvB = [ConvB;  vec(SE_Conv_RZF_maxmin)];
        RIS1B = [RIS1B; vec(SE_RIS_RZF_maxmin1(:,:,1))];
        RIS2bB = [RIS2bB; vec(SE_RIS_RZF_maxmin2b(:,:,1))];
    end
...
legend({'Conv-mMIMO $M=100$', 'RIS-mMIMO, Short-Term, $M=100$', 'RIS-mMIMO, Long-Term, $M=100$', 'Conv-mMIMO $M=32$', 'RIS-mMIMO, Short-Term, $M=32$', 'RIS-mMIMO, Long-Term, $M=32$'   },'Interpreter','Latex','Location','SouthEast');
xlim([0 6]);
