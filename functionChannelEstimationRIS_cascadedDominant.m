...
for k = 1:K
    ...
    bHat1(:,k,:) = sqrt(tau_p*etaa)*Rbar*((tau_p*etaa*Rbar+eye(M))\ReceivedPilot);
    ...
    bHat2(:,k,:) = sqrt(tau_p*etaa)*Rbar*((tau_p*etaa*Rbar+eye(M))\ReceivedPilot);
    ...
    bHat3(:,k,:) = sqrt(tau_p*etaa)*Rbar*((tau_p*etaa*Rbar+eye(M))\ReceivedPilot);
    ...
    bHat4(:,k,:) = sqrt(tau_p*etaa)*Rbar*((tau_p*etaa*Rbar+eye(M))\ReceivedPilot);
    ...
    bHat5(:,k,:) = sqrt(tau_p*etaa)*Rbar*((tau_p*etaa*Rbar+eye(M))\ReceivedPilot);
