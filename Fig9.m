...
legend({'Conv-mMIMO', 'RIS-mMIMO, Short-Term', 'RIS-mMIMO, Long-Term', 'RIS-mMIMO, Short-Term, reduced $\mathcal{K}$', 'RIS-mMIMO, Long-Term, reduced $\mathcal{K}$' },'Interpreter','Latex','Location','SouthEast');
xlim([0 6]);
